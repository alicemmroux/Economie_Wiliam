...
#need to make it disposable_income(t-1)
#def variation_in_households_financial_liabilities(current_liabilities):
 #   return ratio_liabilities_to_disposable_income() * households_disposable_income(net_labor_income_proj, social_benefits_proj, households_income_tax(), property_income_paid, wealth_tax_proj) - current_liabilities
...
def variation_households_financial_assets():
    return households_net_lending() + variation_in_households_financial_liabilities()
